        ...
        <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
            <li class="nav-item">
                <a href="/" class="nav-link" target="_blank">
                    <div class="parent-icon"><i class="fa-brands fa-d-and-d"></i>
                    </div>
                    <div class="menu-title">Trang chủ</div>
                </a>
            </li>
            <li class="nav-item">
                <a href="/view-danh-muc" class="nav-link">
                    <div class="parent-icon"><i class="fa-solid fa-dice-d20"></i>
                    </div>
                    <div class="menu-title">Danh mục game</div>
                </a>
            </li>
            <li class="nav-item">
                <a href="/view-dich-vu" class="nav-link">
                    <div class="parent-icon"><i class="fa-brands fa-usps"></i>
                    </div>
                    <div class="menu-title">Dịch vụ game</div>
                </a>
            </li>
            <li class="nav-item">
                <a href="/view-mini-game" class="nav-link">
